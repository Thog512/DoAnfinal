 ...
 * @author Admin
 */
public class NhapKhoUpdateJFrame extends javax.swing.JFrame {

    /**
     * Creates new form KhachHangJFrame
     */
    public NhapKhoUpdateJFrame(NhapKho nhapKho) {
        initComponents();
    ...
    public void update(){
            ...
            String sql="Update NhapKho set MaNhapKho=?,TenDienThoai=?,SoLuong=?,NhaCungCap=?,NgayNhap=? where MaNhapKho =?";
            ...
            ps.setString(6, jtfMaNhapKho.getText());
            ...
            Logger.getLogger(NhapKhoUpdateJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
        ...
        public void delete(){
            try {
            Connection cons=connectsql.getConnection();
            String sql="Delete from NhapKho where MaNhapKho =?";
            PreparedStatement ps=cons.prepareStatement(sql,PreparedStatement.RETURN_GENERATED_KEYS);
