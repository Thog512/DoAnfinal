 ...
 * @author Admin
 */
public class MobilePhoneUpdateJFrame extends javax.swing.JFrame {

    /**
     * Creates new form HoaDonJFrame
     */
    public MobilePhoneUpdateJFrame(MobilePhone mobilePhone) {
        initComponents();
        ...
        public void update(){
            ...
            String sql="Update MobilePhone set HeDieuHanh=?,MaDT=?,TenDT=?,DonGia=?,SoLuong=? where MaDT =?";
            ...
            Logger.getLogger(MobilePhoneUpdateJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
        ...
        public void delete(){
            try {
            Connection cons=connectsql.getConnection();
            String sql="Delete from MobilePhone where MaDT =?";
            PreparedStatement ps=cons.prepareStatement(sql,PreparedStatement.RETURN_GENERATED_KEYS);
